...
import (
	...
	"github.com/pdexchain/go-pdexchain/common/mclock"
	...
	"github.com/pdexchain/go-pdexchain/light"
	...
	"github.com/pdexchain/go-pdexchain/trie"
)
...
func (pm *ProtocolManager) Stop() {
	...
	log.Info("Light Pdexchain protocol stopped")
}
...
func (pm *ProtocolManager) handle(p *peer) error {
	...
	p.Log().Debug("Light Pdexchain peer connected", "name", p.Name())
	...
	if err := pm.peers.Register(p); err != nil {
		p.Log().Error("Light Pdexchain peer registration failed", "err", err)
		return err
	}
	defer func() {
