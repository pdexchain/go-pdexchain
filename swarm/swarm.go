...
import (
	...
	"github.com/pdexchain/go-pdexchain/accounts/abi/bind"
	"github.com/pdexchain/go-pdexchain/common"
	"github.com/pdexchain/go-pdexchain/contracts/chequebook"
	"github.com/pdexchain/go-pdexchain/contracts/ens"
	"github.com/pdexchain/go-pdexchain/ethclient"
	"github.com/pdexchain/go-pdexchain/metrics"
	"github.com/pdexchain/go-pdexchain/p2p"
	"github.com/pdexchain/go-pdexchain/p2p/discover"
	"github.com/pdexchain/go-pdexchain/p2p/protocols"
	"github.com/pdexchain/go-pdexchain/params"
	"github.com/pdexchain/go-pdexchain/rpc"
	"github.com/pdexchain/go-pdexchain/swarm/api"
	httpapi "github.com/pdexchain/go-pdexchain/swarm/api/http"
	"github.com/pdexchain/go-pdexchain/swarm/fuse"
	"github.com/pdexchain/go-pdexchain/swarm/log"
	"github.com/pdexchain/go-pdexchain/swarm/network"
	"github.com/pdexchain/go-pdexchain/swarm/network/stream"
	"github.com/pdexchain/go-pdexchain/swarm/pss"
	"github.com/pdexchain/go-pdexchain/swarm/state"
	"github.com/pdexchain/go-pdexchain/swarm/storage"
	"github.com/pdexchain/go-pdexchain/swarm/storage/mock"
	"github.com/pdexchain/go-pdexchain/swarm/storage/mru"
	"github.com/pdexchain/go-pdexchain/swarm/tracing"
)
...
func NewSwarm(config *api.Config, mockStore *mock.NodeStore) (self *Swarm, err error) {
	...
	addr := &network.BzzAddr{
		...
		UAddr: []byte(discover.NewNode(nodeID, net.IP{127, 0, 0, 1}, 47380, 47380).String()),
	}
