...
!define HELPURL "https://github.com/pdexchain/go-pdexchain/issues"
!define UPDATEURL "https://github.com/pdexchain/go-pdexchain/releases"
!define ABOUTURL "https://github.com/pdexchain/go-pdexchain#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:47380)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:47380)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:47380)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:47380)" ""  6 1 1 2147483647 1 "$INSTDIR\gpdex.exe" "" "" "Ethereum" 47380 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:47380)" ""  6 2 1 2147483647 1 "$INSTDIR\gpdex.exe" "" "" "Ethereum" "" 47380 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:47380)" "" 17 2 1 2147483647 1 "$INSTDIR\gpdex.exe" "" "" "Ethereum" "" 47380 "" ""
